            ...
            <section className='relative h-[600px] bg-gradient-to-r from-gray-900 to-gray-700 flex items-center justify-center text-white'>
                ...
                <div className='relative z-10 max-w-4xl mx-auto px-4 text-center'>
                    ...
                    <p className='text-xl md:text-2xl mb-8 text-gray-200'>
                        Mbi 2,000 ngjyra dhe modele guri për hapësirën tuaj të
                        ëndrrave
                    </p>
                    <button
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
                        <div className='text-center p-6'>
                            ...
                            <p className='text-gray-600'>
                                Materiale të përzgjedhura me dorë nga guroret më
                                të mira në botë
                            </p>
                        </div>
                        ...
                        <div className='text-center p-6'>
                            ...
                            <p className='text-gray-600'>
                                Udhëzim profesional nga konsulta deri te
                                instalimi
                            </p>
                        </div>
                        ...
                        <div className='text-center p-6'>
                            ...
                            <p className='text-gray-600'>
                                Kohë të shpejta përfundimi pa kompromentuar
                                cilësinë
                            </p>
                        </div>
                    </div>
                ...
                <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
                    <div className='text-center mb-12'>
                        ...
                        <p className='text-xl text-gray-600'>
                            Eksploroni zgjedhjet tona më popullore të mermerit
                            dhe gurit
                        </p>
                    </div>
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-2 gap-12 items-center'>
                        <div>
                            ...
                            <p className='text-lg text-gray-600 mb-6'>
                                Eksploroni mjetet tona të dizajnit të dhomave
                                për të vizualizuar se si llojet e ndryshme të
                                mermerit do të duken në hapësirën tuaj para se
