        ...
        <div className="grid lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-3 bg-white rounded-2xl shadow-2xl p-4 relative overflow-hidden">
            <svg viewBox="0 0 1200 903" className="w-full h-auto block rounded-lg" xmlns="http://www.w3.org/2000/svg">
              <defs>
                {islandPaths.map(({ key }) => (
                  <pattern key={key} id={`${key}Pattern`} patternUnits="userSpaceOnUse" width="1800" height="1800">
                    <image href={selectedMaterials.island || ''} width="1800" height="1800" preserveAspectRatio="xMidYMid slice" />
                  </pattern>
                ))}
