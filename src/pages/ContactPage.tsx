            ...
            <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16'>
                <div className='text-center mb-16'>
                    ...
                    <p className='text-lg text-gray-600 max-w-2xl mx-auto'>
                        Jemi këtu për t'ju përgjigjur çdo pyetjeje dhe për t'ju
                        ndihmuar të gjeni zgjidhjen perfekte për projektin tuaj
                    </p>
                </div>
                ...
                <div className='grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16'>
                    <div className='bg-gradient-to-br from-orange-50 to-orange-100 rounded-2xl shadow-lg p-8 border border-orange-200'>
                        ...
                        <p className='text-gray-700 text-lg leading-relaxed mb-6'>
                            Shikoni koleksionin tonë të gjerë personalisht.
                            Planifikoni një takim me konsulentët tanë të
                            dizajnit për të eksploruar materialet, për të marrë
                            këshilla nga ekspertët dhe për të diskutuar nevojat
                            tuaja të projektit.
                        </p>
                    </div>
                    ...
                    <div className='bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl shadow-lg p-8 border border-gray-200'>
                        ...
                        <ul className='space-y-3 text-gray-700 text-lg'>
                            ...
                            <li className='flex items-start gap-3'>
                                ...
                                <span>
                                    Koleksion i gjerë materialesh premium
                                </span>
                            </li>
                            <li className='flex items-start gap-3'>
                                <span className='text-orange-600 font-bold text-xl'>
                            ...
                            <li className='flex items-start gap-3'>
                                ...
                                <span>
                                    Instalim i garantuar nga specialistë
                                </span>
                            </li>
                        </ul>
                    </div>
