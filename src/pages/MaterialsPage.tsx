        ...
        if (materials.length > 0) {
            const categoryCounts = materials.reduce((acc, material) => {
                const existing = acc.find(
                    (c) => c.category === material.category,
                );
            ...
            // ADD ALL CATEGORY
            const allCategory: CategoryCount = {
                category: "ALL",
                count: materials.length,
            };

            setCategories([allCategory, ...categoryCounts]);
            ...
            <div className='bg-gray-900 text-white py-16'>
                <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
                    ...
                    <p className='text-xl text-gray-300'>
                        Zbuloni koleksionin tonë të gjerë të mermerit dhe gurit
                        natyror
                    </p>
                </div>
            </div>
                            ...
                            {filteredMaterials.length > 0 ? (
                                        ...
                                        >
                                            ...
                                            <div className='p-4'>
                                                <div className='flex items-start justify-between gap-2 mb-2'>
                                                    ...
                                                    <span className='bg-orange-100 text-orange-700 text-xs font-semibold px-2 py-1 rounded-full whitespace-nowrap'>
                                                        {material.category}
                                                    </span>
                                                </div>
                                ...
                                <div className='bg-white rounded-lg shadow-md p-12 text-center'>
                                    <p className='text-gray-500 text-lg'>
                                        Nuk u gjetën lloje materialesh që
                                        përputhen me filtrat tuaj.
                                    </p>
                                </div>
                            )}
                        </div>
                        ...
                        <div className='p-6'>
                            ...
                            <div className='space-y-4'>
                                ...
                                <div className='grid grid-cols-2 gap-4'>
                                    ...
                                    {selectedMaterial.finish_types &&
                                        selectedMaterial.finish_types.length >
                                            0 && (
                                            <div>
                                                <h4 className='font-semibold mb-1'>
                                                    Përfundimet në Dispozicion
                                                </h4>

                                                <p className='text-gray-600'>
                                                    {selectedMaterial.finish_types.join(
                                                        ", ",
                                                    )}
                                                </p>
                                            </div>
